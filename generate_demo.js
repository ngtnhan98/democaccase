...
// We will use item 1 as the template for all cards
...
<style>
  ...
  /* Override the max-height for single item demo */
  ...
  /* Status label styles for case 4.4 */
  .status-label {
    grid-row: 2 / 3;
    grid-column: 2 / 3;
    justify-self: end;
...
console.log('Demo page updated based on DOCX cases.');
